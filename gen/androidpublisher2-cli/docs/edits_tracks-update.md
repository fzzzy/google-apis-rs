...
You can set the scope for this method like this: `androidpublisher2 --scope <scope> edits tracks-update ...`
...
Track:
  track: string
  user-fraction: number
  version-codes: [integer]
