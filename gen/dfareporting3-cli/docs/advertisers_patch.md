...
You can set the scope for this method like this: `dfareporting3 --scope <scope> advertisers patch ...`
...
* `default-click-through-event-tag-id=lorem`
    - ID of the click-through event tag to apply by default to the landing pages of this advertiser&#39;s campaigns.
* `default-email=sed`
    - Default email address used in sender field for tag emails.
* `floodlight-configuration-id=tempor`
...
* `floodlight-configuration-id-dimension-value    dimension-name=clita`
