...
You can set the scope for this method like this: `dfareporting3 --scope <scope> campaigns insert ...`
...
* `..    creative-group-ids=vero`
    - List of creative group IDs that are assigned to the campaign.
    - Each invocation of this argument appends the given value to the array.
* `creative-optimization-configuration    id=dolore`
...
* `..default-click-through-event-tag-properties    default-click-through-event-tag-id=duo`
    - ID of the click-through event tag to apply to all ads in this entity&#39;s scope.
* `override-inherited-event-tag=false`
    - Whether this entity should override the inherited default click-through event tag with its own defined value.

* `..    default-landing-page-id=accusam`
