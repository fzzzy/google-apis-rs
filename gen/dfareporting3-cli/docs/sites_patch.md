...
You can set the scope for this method like this: `dfareporting3 --scope <scope> sites patch ...`
...
* `directory-site-id-dimension-value    dimension-name=at`
