...
* `..    id=magna`
    - Goal ID.
* `internal-web-property-id=ea`
    - Internal ID for the web property to which this goal belongs.
* `kind=sea`
    - Resource type for an Analytics goal.
* `name=ipsum`
    - Goal name.
* `parent-link    href=labore`
...
* `..    value=0.513480517699`
    - Goal value.
* `visit-num-pages-details    comparison-type=eos`
    - Type of comparison. Possible values are LESS_THAN, GREATER_THAN, or EQUAL.
* `comparison-value=nonumy`
    - Value used for this comparison.

* `..visit-time-on-site-details    comparison-type=sanctus`
    - Type of comparison. Possible values are LESS_THAN or GREATER_THAN.
* `comparison-value=voluptua.`
    - Value used for this comparison.
