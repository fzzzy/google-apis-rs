...
* `..web-property-ref    account-id=dolore`
    - Account ID to which this web property belongs.
* `href=sadipscing`
    - Link for this web property.
* `id=ipsum`
    - Web property ID of the form UA-XXXXX-YY.
* `internal-web-property-id=sadipscing`
