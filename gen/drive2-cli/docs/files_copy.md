...
* `id=ut`
    - The ID of the file.
* `image-media-metadata    aperture=0.820349993375`
    - The aperture used to create the photo (f-number).
* `camera-make=eos`
    - The make of the camera used to create the photo.
* `camera-model=voluptua.`
    - The model of the camera used to create the photo.
* `color-space=duo`
    - The color space of the photo.
* `date=sed`
    - The date and time the photo was taken (EXIF format timestamp).
* `exposure-bias=0.694035924993`
    - The exposure bias of the photo (APEX value).
* `exposure-mode=ea`
    - The exposure mode used to create the photo.
* `exposure-time=0.84126108834`
    - The length of the exposure, in seconds.
* `flash-used=false`
    - Whether a flash was used to create the photo.
* `focal-length=0.527160784748`
...
* `location    altitude=0.858839541251`
    - The altitude stored in the image.
* `latitude=0.504277591267`
    - The latitude stored in the image.
* `longitude=0.378784903851`
    - The longitude stored in the image.

* `..    max-aperture-value=0.639492440554`
    - The smallest f-number of the lens at the focal length used to create the photo (APEX value).
* `metering-mode=eirmod`
...
* `...    last-modifying-user-name=eirmod`
    - Name of the last user to modify this file.
* `last-viewed-by-me-date=sanctus`
    - Last time this file was viewed by the user (formatted RFC 3339 timestamp).
* `marked-viewed-by-me-date=voluptua.`
    - Deprecated.
* `md5-checksum=dolor`
...
* `sharing-user    display-name=nonumy`
    - A plain text displayable name for this user.
* `email-address=et`
    - The email address of the user.
...
* `...    spaces=labore`
    ...
    - Each invocation of this argument appends the given value to the array.
* `team-drive-id=aliquyam`
    - ID of the Team Drive the file resides in.
* `thumbnail    image=elitr`
...
* `trashing-user    display-name=consetetur`
    - A plain text displayable name for this user.
* `email-address=diam`
    - The email address of the user.
* `is-authenticated-user=true`
