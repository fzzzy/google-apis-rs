...
You can set the scope for this method like this: `content2-sandbox --scope <scope> orders instorerefundlineitem ...`
...
* `-r .amount-pretax    currency=rebum.`
    - The currency of the price.
* `value=consetetur`
    - The price represented as a number.

* `..amount-tax    currency=sadipscing`
    - The currency of the price.
* `value=vero`
    - The price represented as a number.

* `..    line-item-id=sadipscing`
