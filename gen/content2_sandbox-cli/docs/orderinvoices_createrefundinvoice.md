...
You can set the scope for this method like this: `content2-sandbox --scope <scope> orderinvoices createrefundinvoice ...`
...
* `refund-only-option    description=justo`
    - Optional description of the refund reason.
* `reason=justo`
    - [required] Reason for the refund.

* `..return-option    description=et`
