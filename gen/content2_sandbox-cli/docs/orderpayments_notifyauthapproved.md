...
You can set the scope for this method like this: `content2-sandbox --scope <scope> orderpayments notifyauthapproved ...`
...
* `-r .auth-amount-pretax    currency=diam`
    - The currency of the price.
* `value=ipsum`
    - The price represented as a number.

* `..auth-amount-tax    currency=lorem`
    - The currency of the price.
* `value=et`
    - The price represented as a number.
