...
You can set the scope for this method like this: `sourcerepo1 --scope <scope> projects update-config ...`
...
UpdateProjectConfigRequest:
  project-config:
    enable-private-key-check: boolean
    name: string
  update-mask: string
...
* `-r .project-config    enable-private-key-check=false`
