...
impl<'a, C, A> AccountCustomAppCreateCall<'a, C, A> where C: BorrowMut<hyper::Client<hyper_tls::HttpsConnector<hyper::client::HttpConnector>, hyper::Body>>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    fn doit<RS>(mut self, mut reader: RS, reader_mime_type: mime::Mime, protocol: &'static str) -> Box<Future<Item = (hyper::Response<hyper::Body>, CustomApp), Error = cmn::Error> + Send>
		where RS: ReadSeek {
            ...
            let mut req_fut: hyper::client::ResponseFuture = {
                    ...
                    
                {
                    ...
                    let (mut body_reader, content_type) = match protocol {
                        ...
                        if size > 104857600 {
                        	return Box::new(futures::future::err(Error::UploadSizeLimitExceeded(size, 104857600)))
                        }
    ...
    /// * *multipart*: yes
    /// * *valid mime types*: '*/*'
    pub fn upload<RS>(self, stream: RS, mime_type: mime::Mime) -> Box<Future<Item = (hyper::Response<hyper::Body>, CustomApp), Error = cmn::Error> + Send>
                where RS: ReadSeek {
    ...
    /// * *multipart*: yes
    /// * *valid mime types*: '*/*'
    pub fn upload_resumable<RS>(self, resumeable_stream: RS, mime_type: mime::Mime) -> Box<Future<Item = (hyper::Response<hyper::Body>, CustomApp), Error = cmn::Error> + Send>
                where RS: ReadSeek {
