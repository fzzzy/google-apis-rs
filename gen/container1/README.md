...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-container1/1.0.8+20180917/google_container1/trait.Delegate.html) to the 
