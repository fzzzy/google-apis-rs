...
* `last-modified-info    time=dolore`
    - Timestamp of the last change in milliseconds since epoch.

* `..    latest-trafficked-creative-id=clita`
...
* `progress-offset    offset-percentage=44`
...
* `rendering-id-dimension-value    dimension-name=eirmod`
    - The name of the dimension.
* `etag=sit`
    - The eTag of this response for caching purposes.
* `id=voluptua.`
...
* `..    required-flash-plugin-version=sadipscing`
...
* `..skip-offset    offset-percentage=74`
    - Duration, as a percentage of video duration. Do not set when offsetSeconds is set. Acceptable values are 0 to 100, inclusive.
* `offset-seconds=85`
    - Duration, in seconds. Do not set when offsetPercentage is set. Acceptable values are 0 to 86399, inclusive.
...
* `studio-trafficked-creative-id=ut`
