...
You can set the scope for this method like this: `dfareporting2d8 --scope <scope> placement-groups update ...`
...
* `directory-site-id-dimension-value    dimension-name=duo`
    - The name of the dimension.
* `etag=sit`
    - The eTag of this response for caching purposes.
* `id=lorem`
...
* `id-dimension-value    dimension-name=duo`
    - The name of the dimension.
* `etag=lorem`
    - The eTag of this response for caching purposes.
* `id=duo`
...
* `floodlight-activity-id=consetetur`
...
* `primary-placement-id-dimension-value    dimension-name=diam`
    - The name of the dimension.
* `etag=sit`
    - The eTag of this response for caching purposes.
* `id=amet`
