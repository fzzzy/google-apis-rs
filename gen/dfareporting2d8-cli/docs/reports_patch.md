...
* `criteria.activities    kind=dolor`
    - The kind of resource this is, in this case dfareporting#activities.
* `metric-names=sit`
    - List of names of floodlight activity metrics.
    - Each invocation of this argument appends the given value to the array.

* `..custom-rich-media-events    kind=diam`
    - The kind of resource this is, in this case dfareporting#customRichMediaEvents.

* `..date-range    end-date=labore`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=erat`
    - The kind of resource this is, in this case dfareporting#dateRange.
* `relative-date-range=dolor`
    - The date range relative to the date of when the report is run.
* `start-date=sadipscing`
...
* `..cross-dimension-reach-criteria.date-range    end-date=labore`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=no`
    - The kind of resource this is, in this case dfareporting#dateRange.
...
* `floodlight-criteria.date-range    end-date=kasd`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=ipsum`
    - The kind of resource this is, in this case dfareporting#dateRange.
...
* `owner-profile-id=justo`
    - The user profile id of the owner of this report.
* `path-to-conversion-criteria.date-range    end-date=kasd`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=kasd`
    - The kind of resource this is, in this case dfareporting#dateRange.
* `relative-date-range=amet.`
    - The date range relative to the date of when the report is run.
* `start-date=vero`
    - The start date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
...
* `..custom-rich-media-events    kind=ea`
    - The kind of resource this is, in this case dfareporting#customRichMediaEvents.
