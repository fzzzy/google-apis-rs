...
You can set the scope for this method like this: `dfareporting2d8 --scope <scope> sites update ...`
...
* `directory-site-id-dimension-value    dimension-name=sit`
...
* `creative-settings    i-frame-footer=dolores`
...
* `lookback-configuration    click-duration=68`
    - Lookback window, in days, from the last time a given user clicked on one of your ads. If you enter 0, clicks will not be considered as triggering events for floodlight tracking. If you leave this field blank, the default value for your account will be used. Acceptable values are 0 to 90, inclusive.
* `post-impression-activities-duration=70`
    - Lookback window, in days, from the last time a given user viewed one of your ads. If you enter 0, impressions will not be considered as triggering events for floodlight tracking. If you leave this field blank, the default value for your account will be used. Acceptable values are 0 to 90, inclusive.

* `..tag-setting    additional-key-values=vero`
...
* `vpaid-adapter-choice-template=diam`
