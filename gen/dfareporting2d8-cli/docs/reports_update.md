...
* `criteria.activities    kind=sit`
    - The kind of resource this is, in this case dfareporting#activities.
* `metric-names=et`
    - List of names of floodlight activity metrics.
    - Each invocation of this argument appends the given value to the array.

* `..custom-rich-media-events    kind=ipsum`
...
* `email-owner-delivery-type=amet`
...
* `floodlight-criteria.date-range    end-date=dolore`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=takimata`
    - The kind of resource this is, in this case dfareporting#dateRange.
...
* `..floodlight-config-id    dimension-name=no`
...
* `path-to-conversion-criteria.date-range    end-date=est`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=duo`
    - The kind of resource this is, in this case dfareporting#dateRange.
* `relative-date-range=aliquyam`
...
* `..floodlight-config-id    dimension-name=nonumy`
    - The name of the dimension.
* `etag=ipsum`
    - The eTag of this response for caching purposes.
* `id=accusam`
