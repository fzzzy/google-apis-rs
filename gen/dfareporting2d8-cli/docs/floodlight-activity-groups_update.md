...
You can set the scope for this method like this: `dfareporting2d8 --scope <scope> floodlight-activity-groups update ...`
...
* `floodlight-configuration-id-dimension-value    dimension-name=labore`
    - The name of the dimension.
* `etag=ea`
    - The eTag of this response for caching purposes.
* `id=sit`
