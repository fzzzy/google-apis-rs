...
You can set the scope for this method like this: `dfareporting2d8 --scope <scope> creative-fields insert ...`
...
* `advertiser-id-dimension-value    dimension-name=accusam`
