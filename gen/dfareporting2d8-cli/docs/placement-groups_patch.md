...
* `directory-site-id-dimension-value    dimension-name=vero`
    - The name of the dimension.
* `etag=sit`
    - The eTag of this response for caching purposes.
* `id=est`
...
* `primary-placement-id-dimension-value    dimension-name=lorem`
    - The name of the dimension.
* `etag=ut`
    - The eTag of this response for caching purposes.
* `id=lorem`
