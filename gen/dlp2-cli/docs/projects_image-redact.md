...
You can set the scope for this method like this: `dlp2 --scope <scope> projects image-redact ...`
...
* `..    include-findings=true`
    - Whether the response should include findings along with the redacted
        image.
* `inspect-config    content-options=et`
