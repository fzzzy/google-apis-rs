...
* `-r .    attribute-language=sit`
    - The two-letter ISO 639-1 language in which the attributes are defined in the data feed.
* `content-language=eirmod`
...
* `format    column-delimiter=aliquyam`
