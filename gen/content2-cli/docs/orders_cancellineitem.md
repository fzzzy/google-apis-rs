...
You can set the scope for this method like this: `content2 --scope <scope> orders cancellineitem ...`
...
* `-r .amount    currency=dolor`
    - The currency of the price.
* `value=takimata`
    - The price represented as a number.

* `..amount-pretax    currency=et`
    - The currency of the price.
* `value=nonumy`
    - The price represented as a number.

* `..amount-tax    currency=et`
    - The currency of the price.
* `value=sed`
    - The price represented as a number.
