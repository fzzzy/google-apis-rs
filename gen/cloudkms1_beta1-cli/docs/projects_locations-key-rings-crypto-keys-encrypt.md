...
You can set the scope for this method like this: `cloudkms1-beta1 --scope <scope> projects locations-key-rings-crypto-keys-encrypt ...`
...
* `-r .    additional-authenticated-data=et`
