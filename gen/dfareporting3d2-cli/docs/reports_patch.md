...
* `floodlight-criteria.date-range    end-date=accusam`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=justo`
    - The kind of resource this is, in this case dfareporting#dateRange.
* `relative-date-range=kasd`
    - The date range relative to the date of when the report is run.
* `start-date=kasd`
    - The start date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.

* `..floodlight-config-id    dimension-name=amet.`
...
* `owner-profile-id=dolor`
    - The user profile id of the owner of this report.
* `path-to-conversion-criteria.date-range    end-date=eos`
    - The end date of the date range, inclusive. A string of the format: &#34;yyyy-MM-dd&#34;.
* `kind=lorem`
    - The kind of resource this is, in this case dfareporting#dateRange.
...
* `..floodlight-config-id    dimension-name=ea`
    - The name of the dimension.
* `etag=eos`
    - The eTag of this response for caching purposes.
* `id=eirmod`
...
* `..custom-rich-media-events    kind=sit`
    - The kind of resource this is, in this case dfareporting#customRichMediaEvents.
