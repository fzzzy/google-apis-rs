...
You can set the scope for this method like this: `dfareporting3d2 --scope <scope> sites update ...`
...
* `directory-site-id-dimension-value    dimension-name=dolores`
