...
You can set the scope for this method like this: `dfareporting3d2 --scope <scope> creative-groups insert ...`
...
* `advertiser-id-dimension-value    dimension-name=sanctus`
