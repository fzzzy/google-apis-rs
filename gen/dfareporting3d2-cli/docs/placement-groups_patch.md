...
You can set the scope for this method like this: `dfareporting3d2 --scope <scope> placement-groups patch ...`
...
* `..    child-placement-ids=et`
    - IDs of placements which are assigned to this placement group. This is a read-only, auto-generated field.
    - Each invocation of this argument appends the given value to the array.
* `comment=accusam`
    - Comments for this placement group.
* `content-category-id=sed`
    - ID of the content category assigned to this placement group.
* `create-info    time=ipsum`
    - Timestamp of the last change in milliseconds since epoch.

* `..    directory-site-id=dolores`
...
* `directory-site-id-dimension-value    dimension-name=dolor`
    - The name of the dimension.
* `etag=sadipscing`
    - The eTag of this response for caching purposes.
* `id=no`
...
* `placement-strategy-id=est`
    - ID of the placement strategy assigned to this placement group.
* `pricing-schedule    cap-cost-option=tempor`
...
* `floodlight-activity-id=voluptua.`
...
* `primary-placement-id-dimension-value    dimension-name=justo`
    - The name of the dimension.
* `etag=amet`
    - The eTag of this response for caching purposes.
* `id=duo`
