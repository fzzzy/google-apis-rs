...
You can set the scope for this method like this: `dfareporting3d2 --scope <scope> placements patch ...`
...
* `campaign-id-dimension-value    dimension-name=no`
    - The name of the dimension.
* `etag=est`
    - The eTag of this response for caching purposes.
* `id=amet.`
...
* `last-modified-info    time=clita`
    - Timestamp of the last change in milliseconds since epoch.

* `..lookback-configuration    click-duration=58`
    - Lookback window, in days, from the last time a given user clicked on one of your ads. If you enter 0, clicks will not be considered as triggering events for floodlight tracking. If you leave this field blank, the default value for your account will be used. Acceptable values are 0 to 90, inclusive.
* `post-impression-activities-duration=84`
...
* `placement-group-id=at`
    - ID of this placement&#39;s group, if applicable.
* `placement-group-id-dimension-value    dimension-name=clita`
    - The name of the dimension.
* `etag=consetetur`
    - The eTag of this response for caching purposes.
* `id=et`
...
* `..    placement-strategy-id=sit`
    - ID of the placement strategy assigned to this placement.
* `pricing-schedule    cap-cost-option=nonumy`
...
* `publisher-update-info    time=invidunt`
    - Timestamp of the last change in milliseconds since epoch.

* `..    site-id=sit`
    - Site ID associated with this placement. On insert, you must set either this field or the directorySiteId field to specify the site associated with this placement. This is a required field that is read-only after insertion.
* `site-id-dimension-value    dimension-name=accusam`
    - The name of the dimension.
* `etag=sanctus`
    - The eTag of this response for caching purposes.
* `id=justo`
