...
You can set the scope for this method like this: `dfareporting3d2 --scope <scope> floodlight-activity-groups update ...`
...
* `advertiser-id-dimension-value    dimension-name=magna`
...
* `..    floodlight-configuration-id=sit`
    - Floodlight configuration ID of this floodlight activity group. This is a required field.
* `floodlight-configuration-id-dimension-value    dimension-name=sanctus`
    - The name of the dimension.
* `etag=takimata`
    - The eTag of this response for caching purposes.
* `id=est`
