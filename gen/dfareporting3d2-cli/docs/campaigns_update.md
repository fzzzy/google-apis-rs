...
You can set the scope for this method like this: `dfareporting3d2 --scope <scope> campaigns update ...`
...
* `click-through-url-suffix-properties    click-through-url-suffix=sit`
...
* `..    creative-group-ids=sit`
    - List of creative group IDs that are assigned to the campaign.
    - Each invocation of this argument appends the given value to the array.
* `creative-optimization-configuration    id=vero`
    - ID of this creative optimization config. This field is auto-generated when the campaign is inserted or updated. It can be null for existing campaigns.
* `name=nonumy`
    - Name of this creative optimization config. This is a required field and must be less than 129 characters long.
* `optimization-model=accusam`
    - Optimization model for this configuration.

* `..default-click-through-event-tag-properties    default-click-through-event-tag-id=est`
    - ID of the click-through event tag to apply to all ads in this entity&#39;s scope.
* `override-inherited-event-tag=false`
    - Whether this entity should override the inherited default click-through event tag with its own defined value.

* `..    default-landing-page-id=erat`
...
* `id-dimension-value    dimension-name=clita`
    - The name of the dimension.
* `etag=tempor`
    - The eTag of this response for caching purposes.
* `id=ut`
...
* `last-modified-info    time=eos`
    - Timestamp of the last change in milliseconds since epoch.

* `..lookback-configuration    click-duration=7`
