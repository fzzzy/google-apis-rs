...
* `..    schedule-end-ms=gubergren`
    - The end timestamp in milliseconds to schedule a tag.
* `schedule-start-ms=aliquyam`
    - The start timestamp in milliseconds to schedule a tag.
* `tag-firing-option=eos`
