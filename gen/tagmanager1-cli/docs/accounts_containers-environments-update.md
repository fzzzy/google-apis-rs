...
You can set the scope for this method like this: `tagmanager1 --scope <scope> accounts containers-environments-update ...`
...
* `authorization-timestamp-ms=eirmod`
