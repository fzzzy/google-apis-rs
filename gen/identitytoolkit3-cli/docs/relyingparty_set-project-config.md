...
* `authorized-domains=invidunt`
    - Authorized domains for widget redirect.
    - Each invocation of this argument appends the given value to the array.
* `change-email-template    body=consetetur`
    - Email body.
* `format=dolore`
    - Email body format.
* `from=duo`
...
* `..    delegated-project-number=clita`
    - GCP project number of the requesting delegated app. Currently only intended for Firebase V1 migration.
* `enable-anonymous-user=true`
    - Whether to enable anonymous user.
* `legacy-reset-password-template    body=takimata`
    - Email body.
* `format=nonumy`
    - Email body format.
* `from=kasd`
    - From address of the email.
* `from-display-name=sanctus`
    - From display name.
* `reply-to=takimata`
    - Reply-to address.
* `subject=at`
...
* `..reset-password-template    body=labore`
    - Email body.
* `format=invidunt`
    - Email body format.
* `from=ea`
    - From address of the email.
* `from-display-name=sadipscing`
    - From display name.
* `reply-to=rebum.`
    - Reply-to address.
* `subject=dolore`
