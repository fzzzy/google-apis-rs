...
You can set the scope for this method like this: `androidenterprise1 --scope <scope> managedconfigurationsforuser update ...`
...
* `-r .configuration-variables    kind=dolor`
