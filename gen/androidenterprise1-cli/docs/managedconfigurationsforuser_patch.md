...
You can set the scope for this method like this: `androidenterprise1 --scope <scope> managedconfigurationsforuser patch ...`
...
* `-r .configuration-variables    kind=consetetur`
