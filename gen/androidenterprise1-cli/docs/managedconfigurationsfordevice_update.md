...
You can set the scope for this method like this: `androidenterprise1 --scope <scope> managedconfigurationsfordevice update ...`
...
* **&lt;managed-configuration-for-device-id&gt;** *(string)*
...
* `-r .configuration-variables    kind=sanctus`
