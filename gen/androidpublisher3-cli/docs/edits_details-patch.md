...
You can set the scope for this method like this: `androidpublisher3 --scope <scope> edits details-patch ...`
...
* `-r .    contact-email=nonumy`
    - The user-visible support email for this app.
* `contact-phone=dolores`
    - The user-visible support telephone number for this app.
* `contact-website=gubergren`
    - The user-visible website for this app.
* `default-language=sadipscing`
