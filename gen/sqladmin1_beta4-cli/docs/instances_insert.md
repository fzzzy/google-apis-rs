...
* `mysql-replica-configuration    ca-certificate=kasd`
    - PEM representation of the trusted CA&#39;s x509 certificate.
* `client-certificate=sanctus`
