...
You can set the scope for this method like this: `compute1 --scope <scope> target-ssl-proxies set-ssl-certificates ...`
# Required Scalar Arguments
* **&lt;project&gt;** *(string)*
    - Project ID for this request.
* **&lt;target-ssl-proxy&gt;** *(string)*
