...
You can set the scope for this method like this: `compute1 --scope <scope> region-backend-services patch ...`
...
* `oauth2-client-id=gubergren`
    - No description provided.
* `oauth2-client-secret=ipsum`
    - No description provided.
* `oauth2-client-secret-sha256=kasd`
...
* `security-policy=dolore`
    - [Output Only] The resource URL for the security policy associated with this backend service.
* `self-link=est`
    - [Output Only] Server-defined URL for the resource.
* `session-affinity=invidunt`
